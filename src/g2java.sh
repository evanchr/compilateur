...
ANTLR_JAR=/home/hugo/eclipse-workspace/compilateur/antlr-3.5.2-complete.jar
if [ ! -r $ANTLR_JAR ]
then
...
export CLASSPATH=/home/hugo/eclipse-workspace/compilateur/antlr-3.5.2-complete.jar:.:$CLASSPATH
